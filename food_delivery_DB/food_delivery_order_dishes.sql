...
CREATE TABLE `order_dishes` (
  ...
  KEY `dish_id` (`dish_id`),
  CONSTRAINT `order_dishes_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`),
  CONSTRAINT `order_dishes_ibfk_2` FOREIGN KEY (`dish_id`) REFERENCES `dishes` (`dish_id`)
...
-- Dump completed on 2022-10-08 15:00:18
